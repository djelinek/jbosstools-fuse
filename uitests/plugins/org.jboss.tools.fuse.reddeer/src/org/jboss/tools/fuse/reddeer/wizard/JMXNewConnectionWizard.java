...
public class JMXNewConnectionWizard extends WizardDialog {
	...
	public JMXNewConnectionWizard(String name) {
		super(name);
	}
	...
	public CheckBox getDoNOTVerifySSLCertificatesDangerousForLocalUseOnlyCHB() {
		return new CheckBox("Do NOT verify SSL Certificates (Dangerous, for local use only!!)");
	}

	public String getTextDoNOTVerifySSLCertificatesDangerousForLocalUseOnly() {
	...
	public boolean isCheckedDoNOTVerifySSLCertificatesDangerousForLocalUseOnlyCHB() {
	...
	public void toggleDoNOTVerifySSLCertificatesDangerousForLocalUseOnlyCHB(boolean choice) {
