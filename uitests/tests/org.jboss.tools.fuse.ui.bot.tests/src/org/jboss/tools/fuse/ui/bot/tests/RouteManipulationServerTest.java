...
public class RouteManipulationServerTest {
	...
	public void testRemoteRouteEditing() {
		...
		TreeItem jmxNode = jmx.getNode("Local Processes", "Apache Karaf", "Camel", "_context1");
		jmxNode.select();
		...
		assertNotNull(jmx.getNode("Local Processes", "Apache Karaf", "Camel", "_context1", "Routes", "_route1", "timer:EverySecondTimer", "SetBody _setBody1", "Choice", "Otherwise", "Log _log2"));
		editor.activate();
	...
	public void testTracing() {
		...
		jmxNode = jmx.getNode("Local Processes", "Apache Karaf", "Camel", "_context1");
		jmxNode.select();
