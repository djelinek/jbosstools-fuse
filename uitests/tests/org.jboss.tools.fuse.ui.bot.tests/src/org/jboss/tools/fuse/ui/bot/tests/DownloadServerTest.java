...
public class DownloadServerTest extends DefaultTest {
	...
	public static final String PASSWORD = "fighters";
	...
	public void testDownloadServerRuntimeTest() {
		...
		/*
		 * Handle login, if neccesary.
		 */
		if (parLoginRequired) {
			PushButton buttonAdd = new PushButton(ADD_BUTTON);
			buttonAdd.click();
			new LabeledText("Username:").setText(USERNAME);
			new LabeledText("Password:").setText(PASSWORD);
			PushButton buttonOk = new PushButton("OK");
