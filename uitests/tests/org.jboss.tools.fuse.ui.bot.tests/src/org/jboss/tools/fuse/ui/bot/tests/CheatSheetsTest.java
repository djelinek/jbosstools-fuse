...
public class CheatSheetsTest {
	...
	public static final String TITLE = "Create a Fuse Integration Project";
	...
	public void testCheatSheets() {
		...
		/*
		 * JRE8 missing handle. From ProjectFactory.java by tsedmik.
		 */
		if (!hasJava8) {
			DefaultShell warningMessage = new DefaultShell("No Strictly compliant JRE detected");
